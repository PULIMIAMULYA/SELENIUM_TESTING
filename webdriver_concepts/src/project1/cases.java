...
public class cases {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		WebElement a=d.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[1]/table/tbody/tr/td/table/tbody/tr/td/table/tbody"));
	    ...
	    */
		...
		/*
		WebElement a = d.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/tr[2]/td/table/tbody/tr"));
		List<WebElement> b = a.findElements(By.tagName("a"));
		System.out.println(b.size());
		for(int i=0;i<b.size();i++) {
			System.out.println(b.get(i).getText());
		*/
        ...
        d.findElement(By.name("firstName")).sendKeys("Amulya");
